...
>[] = [
  ...
  },
  {
    ...
    attributes: [
      ...
      },
      {
        ...
        type: "string",
        description: "Date compliance is required by (ISO), if bounded",
      },
      {
        name: "complianceStatus",
        type: "string",
        description: "Derived compliance status from the latest assessment",
        enumValues: [
          "compliant",
          "due",
          "overdue",
  ...
  // ---- Lifecycle events & computable compliance ------------------------
  {
    id: "ShopVisit",
    label: "Shop Visit",
    description:
      "A time-bounded maintenance event for one engine, from induction at the MRO shop to release.",
    parentClass: null,
    deprecated: false,
    attributes: [
      { name: "shopOrder", type: "string", description: "MRO shop order" },
      { name: "mroProvider", type: "string", description: "Performing MRO facility" },
      {
        name: "status",
        type: "string",
        description: "Visit lifecycle status",
        enumValues: ["planned", "inducted", "in_work", "released", "cancelled"],
      },
      { name: "inductionDate", type: "string", description: "Induction date (ISO)" },
      { name: "releaseDate", type: "string", description: "Release date (ISO); empty while open" },
    ],
  },
  {
    id: "WorkOrder",
    label: "Work Order",
    description:
      "The work-package container executed during a shop visit: the set of TCN task executions spawned from one approved recommendation.",
    parentClass: null,
    deprecated: false,
    attributes: [
      {
        name: "status",
        type: "string",
        description: "Rolled-up execution status",
        enumValues: ["not_started", "in_progress", "complete"],
      },
      { name: "taskCount", type: "integer", description: "Number of task executions" },
      { name: "openedAt", type: "string", description: "Opened date (ISO)" },
    ],
  },
  {
    id: "MaintenanceTaskExecution",
    label: "Maintenance Task Execution",
    description:
      "A performed (or in-work) instance of a maintenance task: TCN-tracked, with performer, timestamps and execution status.",
    parentClass: null,
    deprecated: false,
    attributes: [
      { name: "tcn", type: "string", description: "Task Control Number" },
      { name: "performer", type: "string", description: "Assigned technician / performer" },
      {
        name: "status",
        type: "string",
        description: "Execution status",
      ...
      { name: "startedAt", type: "string", description: "Execution start (ISO)" },
  ...
  },
  {
    ...
    description:
      "A dated, evidence-linked determination of an engine's compliance with a directive, derived from live execution state.",
    parentClass: null,
    deprecated: false,
    attributes: [
      {
      ...
      { name: "deadline", type: "string", description: "Compliance deadline (ISO), if bounded" },
...
export const SEED_RELATIONSHIPS: OntologyRelationship[] = [
  ...
  // ---- Lifecycle events & computable compliance ------------------------
  {
    ...
    sourceMultiplicity: "0..*",
    targetMultiplicity: "1",
    description: "A shop visit is a time-bounded maintenance event for one engine.",
    deprecated: false,
  },
  {
    id: "initiatedBy",
    ...
    targetMultiplicity: "0..1",
    description: "A directed shop visit is initiated by an OEM service request (TSR).",
    deprecated: false,
  },
  {
    id: "hasWorkOrder",
    ...
    sourceMultiplicity: "1",
    targetMultiplicity: "0..*",
    description: "A shop visit contains the work orders executed during it.",
    deprecated: false,
  },
  {
    id: "implementsRecommendation",
    label: "implements recommendation",
    domain: "WorkOrder",
    range: "MaintenanceRecommendation",
    sourceMultiplicity: "0..1",
    targetMultiplicity: "1",
    description: "A work order implements one approved maintenance recommendation.",
    deprecated: false,
  },
  {
    id: "hasTaskExecution",
    label: "has task execution",
    domain: "WorkOrder",
    range: "MaintenanceTaskExecution",
    sourceMultiplicity: "1",
    targetMultiplicity: "1..*",
    description: "A work order groups its TCN-tracked task executions.",
    deprecated: false,
  },
  {
    id: "executes",
    label: "executes",
    domain: "MaintenanceTaskExecution",
    range: "MaintenanceTaskDefinition",
    sourceMultiplicity: "0..*",
    targetMultiplicity: "1",
    description:
      "A task execution is the performed instance of a maintenance task definition.",
    deprecated: false,
  },
  {
    id: "observedOn",
    ...
    targetMultiplicity: "1",
    description:
      "A measurement observation is a dated event recorded on a specific engine.",
    deprecated: false,
  },
  {
    id: "directiveAppliesTo",
    label: "applies to (directive)",
    domain: "ComplianceDirective",
    range: "Engine",
    sourceMultiplicity: "0..*",
    targetMultiplicity: "0..*",
    description: "A directive is applicable to specific engines (its effectivity).",
    deprecated: false,
  },
  {
    id: "requiresTask",
    ...
    targetMultiplicity: "0..*",
    description:
      "Complying with a directive requires the work carried by these recommendations.",
    deprecated: false,
  },
  {
    id: "assesses",
    label: "assesses",
    domain: "ComplianceAssessment",
    range: "ComplianceDirective",
    sourceMultiplicity: "0..*",
    targetMultiplicity: "1",
    description: "An assessment determines compliance with one directive.",
    deprecated: false,
  },
  {
    id: "assessedFor",
    ...
    sourceMultiplicity: "0..*",
    targetMultiplicity: "1",
    description: "An assessment is made for a specific engine.",
    deprecated: false,
  },
  {
    id: "supportedByRecommendation",
    label: "supported by recommendation",
    domain: "ComplianceAssessment",
    range: "MaintenanceRecommendation",
    sourceMultiplicity: "0..*",
    targetMultiplicity: "0..1",
    description:
      "The recommendation whose work provides evidence for the assessment.",
    deprecated: false,
  },
  {
    id: "supportedByExecution",
    label: "supported by execution",
    domain: "ComplianceAssessment",
    range: "MaintenanceTaskExecution",
    sourceMultiplicity: "0..*",
    targetMultiplicity: "0..*",
